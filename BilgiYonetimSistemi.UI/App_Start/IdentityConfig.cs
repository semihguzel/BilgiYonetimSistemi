...
namespace MVCOrnek12.Identity
{
    ...
    {
        public ApplicationUserManager(IUserStore<Kullanici> store)
            : base(store)
        {
        }
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<Kullanici>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<Kullanici>
            {
